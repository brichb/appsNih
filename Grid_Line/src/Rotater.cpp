	...
	*/
	...
	if(Ford  == 2)
	{
		...
		*/
		...
		std::ofstream yourfile("Comparisons.txt",std::ios::app);
		...
		yourfile << " Average Maxs_1 " ;
		for(int i = 0; i < Maxs_1.size(); i++)
		{
			yourfile << Maxs_1[i] << " " ;
		}
		yourfile << "\n";
		yourfile << " Average Maxs_2 " ;
	...
	*/
	...
	Temp_Norm_2.push_back(Line);
	 ...
	 //std::cout<<"total_diff: "<<total_diff<<"\n";
		...
		yourfile << "Total Diff " << total_diff <<  " Max point diff " << max << " and Total Points " << meas_counter << "\n" << "\n" ;
		yourfile << " Radi_1 are " << Final_1_1 << " " << Final_2_1 << " " << Final_3_1 << "\n";
		yourfile << " Radi_2 are " << Final_1_2 << " " << Final_2_2 << " " << Final_3_2 << "\n";
		yourfile.close();
					...
					for(int j = y - Final_2_2; j <= y + Final_2_2; j++)
						for(int k = z - Final_3_2; k <= z + Final_3_2; k++)
						{
							if( Second_Skinned_Image->FastGet(i,j,k) == 1000)
							{
								...
								std::ofstream myfile("Differences.csv", std::ios::app);
								myfile << "\n" <<  i << "," << j << "," << k << "," <<  5000 + crawl_count*1000;
							}
						}
				...
				for(int i = x - Final_1_1; i <= x + Final_1_1; i++)
					for(int j = y - Final_2_1; j <= y + Final_2_1; j++)
						for(int k = z - Final_3_1; k <= z + Final_3_1; k++)
						{
							...
							std::ofstream myfile("Differences2.csv", std::ios::app);
								myfile << "\n" <<  i << "," << j << "," << k << "," <<  5000 + crawl_count*1000;
							}
